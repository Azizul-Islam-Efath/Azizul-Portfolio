...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="relative w-full min-h-screen overflow-hidden bg-[#07111B] text-white"
    >
      {/* ═══════════════ BACKGROUND GLOWS ═══════════════ */}
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        />
        {/* Added the missing closing div tag below */}
      </div>
        ...
        <div className="text-center max-w-5xl">
          ...
          <div className="hero-item mt-6 flex flex-col sm:flex-row items-center justify-center gap-5">
            <button
              ...
              className="group px-10 py-4 rounded-full bg-[#F3DDD0] text-black font-semibold text-base transition-all duration-500 hover:scale-105 hover:shadow-[0_0_50px_rgba(243,221,208,0.35)]"
            >
              View Projects →
            </button>
            <button
              onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}
              className="group px-10 py-4 rounded-full border border-white/20 bg-white/[0.04] backdrop-blur-2xl text-white text-base transition-all duration-500 hover:bg-white/[0.08] hover:scale-105"
            >
              Contact Me ↗
            </button>
          </div>
